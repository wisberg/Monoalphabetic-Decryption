Monoalphabetic Decryption Helper // // main.cpp // Monoalphabetic Decryption Helper // // Created by Duff Isberg on 2020. // Copyright (c) 2020 Duff Isberg. All rights reserved. //

#include #include using namespace std;

class letters{ public: int letter; double frequency = 0; double percentage; };

void letterSearch(char findLetter, letters Alphabet[]) { int findLetterNum = static_cast(findLetter);
...
int main() { letters englishPercent[26]; //Set an array with the frequencies in alphabetical order, then set this englishPercent array to each percent with a for loop. Then sort them in ascending like you did below then youl be able to output the letter with its frequency for comparison double ePercents[26] = {8.167, 1.492, 2.782, 4.253, 12.702, 2.228, 2.015, 6.094, 6.966, 0.153, 0.772, 4.025, 2.406, 6.749, 7.507, 1.929, 0.095, 5.987, 6.327, 9.056, 2.758, 0.978, 2.361, 0.150, 1.974, 0.074};
